			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="content.learningObjective.label" default="Learning Objective" /></th>
					
						<th><g:message code="content.priority.label" default="Priority" /></th>
				...
				<g:each in="${contentInstanceList}" status="i" var="contentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${contentInstance.id}">${fieldValue(bean: contentInstance, field: "learningObjective")}</g:link></td>
